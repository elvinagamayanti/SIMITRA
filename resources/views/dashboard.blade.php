                ...
                <div class="max-w-sm w-full bg-white rounded-lg shadow p-4 md:p-6 mx-auto">
                    <div class="flex justify-between mb-3">
                        ...
                        <div class="flex justify-center items-center">
                            <h5 class="text-xl font-bold leading-none text-gray-900 pe-1">Your team's progress</h5>
                    ...
                    <div class="bg-gray-50 p-3 rounded-lg">
                        ...
                        <button data-collapse-toggle="more-details" type="button" class="hover:underline text-xs text-gray-500 font-medium inline-flex items-center">Show more details <svg class="w-2 h-2 ms-1" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                    ...
                    <div class="grid grid-cols-1 items-center border-gray-200 border-t justify-between">
                        ...
                        <a
                            href="#"
                            class="uppercase text-sm font-semibold inline-flex items-center rounded-lg text-blue-600 hover:text-blue-700 hover:bg-gray-100 dark:border-gray-700 px-3 py-2">
                            Progress report
