...
<div class="container mx-auto p-4">
    ...
    <form  action="{{ route('survey.store') }}" method="POST" enctype="multipart/form-data" class="bg-white p-6 rounded-lg shadow-md">
        @csrf

        <div class="mb-4">
            <label for="nama" class="block text-sm font-medium text-gray-700">Nama Survei</label>
        ...
        <div class="mb-4">
            <label for="kode" class="block text-sm font-medium text-gray-700">Kode Survei</label>
        ...
        <div class="mb-4">
            ...
            <input type="text" name="ketua_tim" id="ketua_tim" class="mt-1 block w-full p-2 border border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500" required>
        </div>
        ...
        <div class="mb-4">
            ...
            <input type="date" name="tanggal_berakhir" id="tanggal_berakhir" class="mt-1 block w-full p-2 border border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500" required>
        </div>
