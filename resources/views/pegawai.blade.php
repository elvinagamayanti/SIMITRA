...
<div class="container mx-auto p-4">
    <h1 class="text-3xl font-bold mb-4">Daftar Pegawai</h1>
    ...
    <div class="mt-6">
        <div class="flex justify-between mb-4">
            ...
            <div class="flex space-x-4">
                ...
                <button onclick="window.location='{{ route('addpegawai') }}'" class="inline-flex items-center px-4 py-2 text-white bg-orange-500 border border-transparent rounded-lg shadow-sm hover:bg-orange-600 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2">
                    Tambah Pegawai
                </button>
            </div>
        </div>
                    ...
                    <tbody>
                        <tr class="bg-white border-b">
                            ...
                            <td class="px-6 py-4">
                                ...
                                <button onclick="window.location='{{ route('editpegawai') }}'" class="ml-2 px-3 py-1 text-white bg-green-600 rounded hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500">Edit</button>
                            </td>
                        </tr>
                    </tbody>
                    <tbody>
