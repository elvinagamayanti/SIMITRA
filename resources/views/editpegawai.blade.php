...
<div class="container mx-auto p-4">
    <h1 class="text-3xl font-bold mb-4">Edit Mitra</h1>

    <form  action="{{ route('editpegawai.store') }}" method="POST" enctype="multipart/form-data" class="bg-white p-6 rounded-lg shadow-md">
        @csrf
